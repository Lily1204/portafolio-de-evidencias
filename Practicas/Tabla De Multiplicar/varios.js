		...
		if (oTbl.rows.length>1){
			for (i=1; i<=10; i++){
				...
				if (isNaN(sValorCapturado))
					...
					nCalif++;
					//colorear los resultados correctos 
					var color=document.getElementById("txtResultado"+i);
					color.style.backgroundColor="green";
				}else{
					//colorear los resultado herroneos 
					var color2=document.getElementById("txtResultado"+i);
